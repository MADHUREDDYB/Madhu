...
@app.callback(
    ...
    Input('submit_2', 'n_clicks'),
    State('level_2_generated', 'value'))
def update_dashboard_message_board_1(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_2', 'n_clicks'),
    State('level_2_generated', 'value'))
def update_dashboard_message_board_2(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_2', 'n_clicks'),
    State('level_2_generated', 'value'))
def update_dashboard_message_board_3(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_2', 'n_clicks'),
    State('level_2_generated', 'value'))
def update_dashboard_message_board_4(n_clicks, selection_list):
...
def update_dashboard_message_board_5(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_6(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_7(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_8(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_9(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_10(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_11(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_12(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_13(n_clicks, selection_list):
...
@app.callback(
    ...
    Input('submit_3', 'n_clicks'),
    State('level_3_generated', 'value'))
def update_dashboard_message_board_14(n_clicks, selection_list):
    ...
    if n_clicks > 0:
        if selection_list != None:
            if 'Test Case Generation' in selection_list:
                ...
                _val = _val + '<BR>Process completed for JIRA Test Case Generation'
                children_list.append(html.Div([html.Iframe(id = "test_case_generation", srcDoc = f'{datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")} : {_val}', style = {'border' : 0, 'width' : '100%', 'height' : (len(_val.split('<BR>')) * 25) + (math.ceil(len(_val)/170) * 25)}
)]))
                return(children_list, f'{datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")} : {_val}')
    return(None, None)
    ...
    if n_clicks > 0:
        if selection_list != None:
            if 'Lake - Lake Hist Query Generation' in selection_list:
                ...
                _val = "Lake Layer to Lake Hist Layer Query Generation Completed Successfully, Validation results placed at : %s" % _val
    ...
    if n_clicks > 0:
        if selection_list != None:
            if 'Lake Hist - Hub query Generation' in selection_list:
                ...
                _val = "Lake Hist Layer to Hub Layer Query Generation Completed Successfully, Validation results placed at : %s" % _val
    ...
    if n_clicks > 0:
        if selection_list != None:
            if 'Hub to Mart Query Generataion' in selection_list:
                ...
                _val = "Hub Layer to Mart Layer Query Generation Completed Successfully, Validation results placed at : %s" % _val
